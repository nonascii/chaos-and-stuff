...
class Point:
    ...
    def swap(self,dt):
        ...
        self._x , self._y, self._z = (self._x + 2.0*math.e ** (-1.0 * dt *(1.0/6.28)) * math.sin(dt + self._y * 2*self._z),
                                       self._y - 2.0 *math.e ** (-1.0 * dt *(1.0/6.28)) * math.cos(dt + self._z *.5* self._x),
                                     self._z - 2.0 *math.e ** (-1.0 * dt *(1.0/6.28)) * math.sin(dt + self._x * self._y) )
