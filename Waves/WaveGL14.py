...
class Point:
    ...
    def swap(self,dt):
        ...
        self._x , self._y, self._z = (self._x,
                                      self._y,
                                     1.0 *math.e ** (-1.0 * dt *(1.0/6.28)) * math.sin(2*dt + math.sqrt(self._x**2 + self._y**2)))
#                                     2.0 *math.e ** (-1.0 * dt *(1.0/6.28)) * math.cos(dt + math.sqrt(self._x**2 + self._y**2)))
