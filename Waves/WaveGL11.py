...
class Point:
    ...
    def swap(self,dt):
        ...
        self._x , self._y, self._z = (self._x,
                                      self._y,
                                      2.0 * math.sin(dt + math.sqrt(self._x**2 + self._y**2) ) *
                                      2.0 * math.cos(dt + math.sqrt(self._x**2 + self._y**2) ) )
        ...
        while True:
            ...
            for point in points:
                if (point._x != 0.0):
                    if (point._y != 0.0):
                        if (point._z != 0.0):
                            glColor3f( 10.0/math.fabs( point._x), 10.0/math.fabs( point._y),1.0/math.fabs( point._z))
                            #glVertex3f( point._x, point._y, 0.0 )
                            glVertex3f( point._x, point._y, point._z )
                            point.swap(age)
                        else:
                            glColor3f( 10.0/math.fabs( point._x), 10.0/math.fabs( point._y),0)
                            #glVertex3f( point._x, point._y, 0.0 )
                            glVertex3f( point._x, point._y, point._z )
                            point.swap(age)
