...
class Point:
    ...
    def swap(self,dt):
        self._x , self._y, self._z = self._x + 0.1 * (self._y + self._z)*(dt * dt) + math.sin(self._y +6.28*dt),\
                                     self._y - 0.1 * (self._x - self._z)*(dt * dt) + math.cos(self._z +6.28*dt),\
                                     self._z - 0.1 * (self._x + self._y)*(dt * dt) + math.sin(self._x +6.28*dt),
